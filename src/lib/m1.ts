        ...
        applyOptimistic: () => {
          qc.setQueryData(['m1', enterpriseId], (old: unknown) => {
            ...
            return {
              ...
              ...(payload.cashbook           !== undefined && { cashbook:           payload.cashbook }),
              ...(payload.financial_report   !== undefined && { financial_report:   payload.financial_report }),
              ...(payload.bank_reconciliation!== undefined && { bank_reconciliation:payload.bank_reconciliation }),
