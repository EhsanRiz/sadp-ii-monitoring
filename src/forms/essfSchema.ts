  ...
  groups: [
    {
      ...
      questions: [
        ...
        { id: 'a8', label: 'Be located in or near an area where there is an important historical, archaeological or cultural heritage site?' },
        { id: 'a9', label: 'Be located within or adjacent to any areas that are or may be protected by government (e.g. national park, national reserve, world heritage site) or local tradition, or that might be a natural habitat?' },
        { id: 'a10', label: 'Depend on water supply from an existing dam, weir, or other water diversion structure?' },
      ],
    },
    {
      id: 'B',
      ...
      questions: [
        ...
        { id: 'b2', label: 'Affect the quantity or quality of surface waters (e.g. rivers, streams, wetlands), or groundwater (e.g. wells)?' },
        { id: 'b3', label: 'Cause poor water drainage and increase the risk of water-related diseases such as malaria or bilharzia?' },
        { id: 'b4', label: 'Harvest or exploit a significant amount of natural resources such as trees, soil or water?' },
        { id: 'b5', label: 'Be located within or nearby environmentally sensitive areas (e.g. intact natural forests, mangroves, wetlands) or threatened species?' },
        { id: 'b6', label: 'Create a risk of increased soil degradation or erosion?' },
        { id: 'b7', label: 'Create a risk of increasing soil salinity?' },
        { id: 'b8', label: 'Produce, or increase the production of, solid or liquid wastes (e.g. water, medical, domestic or construction wastes)?' },
      ],
    },
    {
      id: 'C',
      ...
      questions: [
        { id: 'c1', label: 'Require that land (public or private) be acquired (temporarily or permanently) for its development?' },
        { id: 'c2', label: 'Use land that is currently occupied or regularly used for productive purposes (e.g. gardening, farming, pasture, fishing locations, forests)' },
        { id: 'c3', label: 'Displace individuals, families or businesses?' },
        { id: 'c4', label: 'Result in the temporary or permanent loss of crops, fruit trees or household infrastructure such as granaries, outside toilets and kitchens?' },
        { id: 'c5', label: 'Result in the involuntary restriction of access by people to legally designated parks and protected areas?' },
      ],
    },
    {
      id: 'D',
      ...
      questions: [
        { id: 'd1', label: 'Involve the use of pesticides or other agricultural chemicals, or increase existing use?' },
      ],
    },
  ],
} as const;
